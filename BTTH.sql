...
-- Câu 1
SELECT o.order_id, o.order_date, o.status, c.customer_id, c.customer_name
FROM orders o
JOIN customers c ON c.customer_id = o.customer_id
ORDER BY o.order_date, o.order_id;

-- Câu 2
SELECT o.order_id, p.product_id, p.product_name, oi.quantity
FROM orders o
...
-- Câu 7
SELECT p.product_id, p.product_name, SUM(oi.quantity * oi.unit_price) AS product_revenue
FROM products p
